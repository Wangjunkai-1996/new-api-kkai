...
export const STATIC_I18N_KEYS = [
  ...
  // Video Studio runtime labels and validation messages
  'videoStudio.mode.text',
  'videoStudio.mode.image',
  'videoStudio.mode.firstLast',
  'videoStudio.referenceImage',
  'videoStudio.referenceVideo',
  'videoStudio.firstFrame',
  'videoStudio.lastFrame',
  'videoStudio.status.queued',
  'videoStudio.status.processing',
  'videoStudio.status.archiving',
  'videoStudio.status.ready',
  'videoStudio.status.failed',
  ...
  'videoStudio.validation.modelRequired',
  'videoStudio.validation.nameRequired',
  ...
  'videoStudio.validation.sortOutOfRange',
  'videoStudio.validation.promptRequired',
  'videoStudio.validation.promptTooLong',
  'videoStudio.validation.sampleVideoRequired',
  'videoStudio.validation.sampleDurationUnsupported',
  'videoStudio.validation.videoRequired',
  'videoStudio.validation.modeUnsupported',
  'videoStudio.validation.imageRequired',
  'videoStudio.validation.twoFramesRequired',
  'videoStudio.validation.parameterRequired',
  'videoStudio.validation.parameterInvalid',
  'videoStudio.validation.parameterOutOfRange',
  'videoStudio.validation.modeRequired',
  'videoStudio.validation.optionLabelRequired',
  'videoStudio.validation.optionValueInvalid',
  'videoStudio.validation.parameterDefaultInvalid',
  'videoStudio.validation.parameterDefaultRequired',
  'videoStudio.validation.parameterKeyDuplicate',
  'videoStudio.validation.parameterKeyInvalid',
  'videoStudio.validation.parameterLabelRequired',
  'videoStudio.validation.parameterModeInvalid',
  'videoStudio.validation.parameterModeRequired',
  'videoStudio.validation.parameterOptionRequired',
  'videoStudio.validation.parameterRangeInvalid',
  'videoStudio.validation.parameterRequestKeyDuplicate',
  'videoStudio.validation.parameterStepInvalid',
  'videoStudio.validation.referenceRequestKeyRequired',
  'videoStudio.admin.control.segmented',
  'videoStudio.admin.control.select',
  'videoStudio.admin.control.slider',
  'videoStudio.admin.control.number',
  'videoStudio.admin.control.switch',
  'videoStudio.admin.parameterMin',
  'videoStudio.admin.parameterMax',
  'videoStudio.admin.parameterStep',
  'videoStudio.parameter.durationSeconds',
  'videoStudio.parameter.aspectRatio',
  'videoStudio.parameter.generateAudio',
  'videoStudio.ratio.landscape16x9',
  'videoStudio.ratio.portrait9x16',
  'videoStudio.ratio.square1x1',
  'videoStudio.ratio.landscape4x3',
  'videoStudio.ratio.portrait3x4',
  'videoStudio.ratio.ultrawide21x9',
  'videoStudio.ratio.adaptive',

  // Image Studio dynamic labels and validation messages
  'imageStudio.create',
  'imageStudio.library',
  'imageStudio.status.submitting',
  'imageStudio.status.succeeded',
  'imageStudio.status.partial',
  'imageStudio.status.failed',
  'imageStudio.status.archive_failed',
  'imageStudio.status.unknown',
  'imageStudio.admin.status.draft',
  'imageStudio.admin.status.published',
  'imageStudio.admin.min',
  'imageStudio.admin.max',
  'imageStudio.admin.required',
  'imageStudio.admin.has_default',
  'imageStudio.validation.modelRequired',
  'imageStudio.validation.nameRequired',
  'imageStudio.validation.nameTooLong',
  'imageStudio.validation.descriptionTooLong',
  'imageStudio.validation.providerTooLong',
  'imageStudio.validation.sortOutOfRange',
  'imageStudio.validation.parametersTooMany',
  'imageStudio.validation.parameterKey',
  'imageStudio.validation.parameterLabel',
  'imageStudio.validation.parameterDuplicate',
  'imageStudio.validation.parameterRequired',
  'imageStudio.validation.parameterInvalid',
  'imageStudio.validation.parameterInteger',
  'imageStudio.validation.parameterRange',
  'imageStudio.validation.referenceCountRange',
  'imageStudio.validation.requestFieldDuplicate',
  'imageStudio.validation.requiredDefault',
  'imageStudio.validation.optionsRequired',
  'imageStudio.validation.defaultInvalid',
  'imageStudio.validation.rangeInvalid',
  'imageStudio.validation.promptRequired',
  'imageStudio.validation.promptTooLong',
  'imageStudio.validation.sampleImageRequired',
  'imageStudio.validation.sampleTitleRequired',
  'imageStudio.validation.sampleTitleTooLong',
  'imageStudio.validation.categoryInvalid',
  'imageStudio.validation.mediaUrlInvalid',
  'imageStudio.validation.tokenInvalid',
  ...
  // Invitation rebates (dynamic labels and settlement results)
  'subscription',
  'topup',
  'Pending',
  'Requested',
  ...
  'Completed',
  'Rejected',
  'Approve rebate request?',
  'Approve and pay rebate request?',
  'Approve and pay selected requests?',
  'Reject rebate request?',
  'Reset rebate review?',
  'Mark rebate request completed?',
  'Undo completed rebate request?',
  'Settlement: {{paid}} paid, {{alreadyPaid}} already paid, {{pending}} pending, {{failed}} failed',
  'Payout is pending',
  'Payout failed',
  'Payout is disabled',
  'Payout ledger updated',
  'Payout result requires review',
