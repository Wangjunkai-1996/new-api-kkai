...
var seedanceDurationBounds = map[string][2]int{
	...
	// Seedance 2.5 uses one Model Center upstream model, but the public model
	// names represent separately priced capability tiers. Keep each name
	...
	// 720p tier. The formal 2.5 names use the same sd_2.5_special_* naming
